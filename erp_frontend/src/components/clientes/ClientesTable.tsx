...
const clientesMock: Cliente[] = [
  { id: 1, nome: 'Tech Solutions Ltda', email: 'contato@techsolutions.com.br', documento: '12.345.678/0001-90', telefone: '(11) 98888-7777', ativo: true },
  { id: 2, nome: 'João da Silva', email: 'joao.silva@gmail.com', documento: '123.456.789-00', telefone: '(17) 99999-8888', ativo: true },
  { id: 3, nome: 'Padaria do Zé', email: 'financeiro@padariaze.com', documento: '98.765.432/0001-11', telefone: '(21) 3333-4444', ativo: false },
];
...
export function ClientesTable({ onDelete }: ClientesTableProps) {
  return (
